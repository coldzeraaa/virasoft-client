...
export function LastOrderCard({ order }: { order: NonNullable<MeOrdersQuery['me']>['orders']['nodes']['0'] }) {
  return (
    <Link
      ...
      className="flex h-full w-full gap-2 rounded-lg border bg-base-100 p-4 transition-all duration-100 hover:cursor-pointer hover:bg-base-200 md:gap-6 lg:p-6"
    >
