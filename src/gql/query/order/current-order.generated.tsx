...
export function useCurrentOrderQuery(
  baseOptions?: Apollo.QueryHookOptions<
    CurrentOrderQuery,
    CurrentOrderQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<CurrentOrderQuery, CurrentOrderQueryVariables>(
...
export function useCurrentOrderLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<CurrentOrderQuery, CurrentOrderQueryVariables>(
    CurrentOrderDocument,
    options,
  );
}
export function useCurrentOrderSuspenseQuery(
  ...
  return Apollo.useSuspenseQuery<CurrentOrderQuery, CurrentOrderQueryVariables>(
    CurrentOrderDocument,
    options,
  );
}
export type CurrentOrderQueryHookResult = ReturnType<
  typeof useCurrentOrderQuery
>;
export type CurrentOrderLazyQueryHookResult = ReturnType<
  typeof useCurrentOrderLazyQuery
>;
export type CurrentOrderSuspenseQueryHookResult = ReturnType<
  typeof useCurrentOrderSuspenseQuery
>;
export type CurrentOrderQueryResult = Apollo.QueryResult<
  CurrentOrderQuery,
  CurrentOrderQueryVariables
>;
