...
export function useHeaderFooterQuery(
  ...
  return Apollo.useQuery<HeaderFooterQuery, HeaderFooterQueryVariables>(
...
export function useHeaderFooterLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<HeaderFooterQuery, HeaderFooterQueryVariables>(
    HeaderFooterDocument,
    options,
  );
}
export function useHeaderFooterSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
  ...
  return Apollo.useSuspenseQuery<HeaderFooterQuery, HeaderFooterQueryVariables>(
    HeaderFooterDocument,
    options,
  );
}
...
>;
export type HeaderFooterSuspenseQueryHookResult = ReturnType<
  typeof useHeaderFooterSuspenseQuery
>;
