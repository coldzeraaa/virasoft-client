    ...
    <Form className="space-y-4">
      <Field name="name" rules={[{ required: true, message: 'Нэрээ оруулна уу' }]}>
        <input
          ...
          className="input input-bordered w-full border-l-0 border-r-0 border-t-0 bg-transparent placeholder-base-content focus:outline-0"
        />
      </Field>
      <Field
        name="email"
      ...
      <Field name="message" rules={[{ required: true, message: 'Мессежээ оруулна уу' }]}>
        <textarea
          ...
          className="input input-bordered w-full resize-none border-l-0 border-r-0 border-t-0 bg-transparent placeholder-base-content focus:outline-0"
        />
      </Field>
