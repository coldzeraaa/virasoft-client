...
export type MyOrdersQuery = { __typename?: 'Query', me?: { __typename?: 'User', id: string, orders: { __typename?: 'OrderConnection', edges: Array<{ __typename?: 'OrderEdge', node: { __typename?: 'Order', id: string, number: string, createdAt: any, total?: number | null, itemCount?: number | null, paymentStatus: Types.PaymentStatus, items: Array<{ __typename?: 'Item', id: string, variant: { __typename?: 'Variant', id: string, images: Array<string>, product: { __typename?: 'Product', id: string, name: string, slug: string } } }> } }>, pageInfo: { __typename?: 'PageInfo', endCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null } } } | null };
...
export const MyOrdersDocument = gql`
  ...
  me {
    id
    orders(first: 20, after: $after, sort: {field: "createdAt", direction: desc}) {
      edges {
        node {
          ...MeOrderFields
        }
