...
export function ContactForm() {
  ...
  return (
    <Form className="space-y-4">
      ...
      <Field name="email"  rules={[{ required: true, message: 'И-мэйл хаягаа оруулна уу' },{ type: 'email', message: 'Зөв и-мэйл хаяг оруулна уу' }]}>
      ...
      <button type="submit" className="btn btn-primary text-info-content w-fit"> ИЛГЭЭХ</button>
    </Form>
  );
}
