...
export type Mutation = {
  ...
  createSmsMethod?: Maybe<SmsMethod>;
  ...
  destroySmsMethod?: Maybe<SmsMethod>;
  ...
  removeOptionValue?: Maybe<Variant>;
  ...
  updateSmsMethod?: Maybe<SmsMethod>;
...
export type MutationCreateSmsMethodArgs = {
  input: CreateSmsMethodInput;
};
...
export type MutationDestroySmsMethodArgs = {
  input: DestroySmsMethodInput;
};
...
export type MutationUpdateSmsMethodArgs = {
  input: UpdateSmsMethodInput;
};
...
export type SmsMethod = BaseModelInterface & {
  __typename?: 'SmsMethod';
  active: Scalars['Boolean']['output'];
  createdAt: Scalars['ISO8601DateTime']['output'];
  description?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
...
/** Autogenerated input type of createSmsMethod */
export type CreateSmsMethodInput = {
  active?: InputMaybe<Scalars['Boolean']['input']>;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  description?: InputMaybe<Scalars['String']['input']>;
...
/** Autogenerated input type of destroySmsMethod */
export type DestroySmsMethodInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  id: Scalars['ID']['input'];
};
...
/** Autogenerated input type of removeOptionValue */
...
/** Autogenerated input type of updateSmsMethod */
export type UpdateSmsMethodInput = {
  active?: InputMaybe<Scalars['Boolean']['input']>;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  description?: InputMaybe<Scalars['String']['input']>;
