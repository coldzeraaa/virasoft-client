  ...
  return (
    <div className="w-full" data-single-id={id}>
      <Link href={`/product/${slug}`} className="relative">
        <Image
          src={images['1'] ? imageUrlHelper(images['1']) : `https://via.placeholder.com/80`}
          alt={name}
          width={100}
          height={100}
          className="mb-2 aspect-square w-full rounded-lg bg-base-200 object-contain"
        />
        {is_sale && (
      ...
      <p className="t-text-xs mb-0.5">{title}</p>
