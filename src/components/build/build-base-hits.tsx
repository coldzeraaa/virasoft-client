...
export function BuildBaseHits({ type }: { type: string }) {
  ...
  return (
    <ul className="space-y-2">
      <Loader
        hits={hits}
        dfl={results?.disjunctiveFacets?.length || 0}
        type={type}
      />
    </ul>
  );
  ...
  return (
    ...
    >
      ...
      <Image
        ...
        height={80}
      />
      <p className="text-xl font-semibold transition-transform duration-300 group-hover:translate-x-2">
        {title}
      </p>
