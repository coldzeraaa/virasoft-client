...
`;
export type QuickBuyMutationFn = Apollo.MutationFunction<
  QuickBuyMutation,
  QuickBuyMutationVariables
>;
 ...
 * });
 */
export function useQuickBuyMutation(
  ...
  return Apollo.useMutation<QuickBuyMutation, QuickBuyMutationVariables>(
    QuickBuyDocument,
    options,
  );
}
...
export type QuickBuyMutationOptions = Apollo.BaseMutationOptions<
  QuickBuyMutation,
  QuickBuyMutationVariables
>;
