...
`;
export type UpdateCheckoutAddressMutationFn = Apollo.MutationFunction<
...
export function useUpdateCheckoutAddressMutation(
  ...
  return Apollo.useMutation<
    UpdateCheckoutAddressMutation,
    UpdateCheckoutAddressMutationVariables
  >(UpdateCheckoutAddressDocument, options);
}
export type UpdateCheckoutAddressMutationHookResult = ReturnType<
  typeof useUpdateCheckoutAddressMutation
>;
export type UpdateCheckoutAddressMutationResult =
  Apollo.MutationResult<UpdateCheckoutAddressMutation>;
export type UpdateCheckoutAddressMutationOptions = Apollo.BaseMutationOptions<
  UpdateCheckoutAddressMutation,
  UpdateCheckoutAddressMutationVariables
>;
